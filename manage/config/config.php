...
define('COOKIE_DOMAIN', '.iksnumbers.com/manage'); // the domain where the cookie is valid for, like '.mydomain.com'
...
define("EMAIL_SMTP_HOST", 'mail.iksnumbers.com');
define("EMAIL_SMTP_AUTH", true); // leave this true until your SMTP can be used without login
define("EMAIL_SMTP_USERNAME", 'info@iksnumbers.com');
define("EMAIL_SMTP_PASSWORD", 'dwbQMOyKPCIQGExoCLAY');
define("EMAIL_SMTP_PORT", 465);
define("EMAIL_SMTP_ENCRYPTION", 'ssl');
...
define("EMAIL_PASSWORDRESET_URL", "http://iksnumbers.com/manage/password_reset.php");
define("EMAIL_PASSWORDRESET_FROM", "noreply@iksnumbers.com");
define("EMAIL_PASSWORDRESET_FROM_NAME", "iksnumbers.com");
define("EMAIL_PASSWORDRESET_SUBJECT", "Password reset for iksnumbers panel");
...
define("EMAIL_VERIFICATION_URL", "http://iksnumbers.com/manage/register.php");
define("EMAIL_VERIFICATION_FROM", "noreply@iksnumbers.com");
